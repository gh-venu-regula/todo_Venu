...
// React component for rendering the content of a todo item
export default function TodoContent({ todo, fetchTasks }) {
  const bgcolors = { "social": "green", "work": "orange", "personal": "blue", "other": "gray" }; // Background colors for tags
  ...
  return (
    <div className={classes.todoContent}> 
      <div className={classes.ContentHead}> 
        ...
        >
          <Image
            src={todo.priority === 1 ? LowPriority : todo.priority === 2 ? MediumPriority : HighPriority} // Priority icon based on priority level
            alt="Task Icon"
            width={15}
            height={15}
